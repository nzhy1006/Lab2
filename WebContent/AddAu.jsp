...
<script>
    function checkform(){
        ...
        if(document.getElementById('nn').value == null ||
        document.getElementById('nn').value == "") {
           alert("NO publisher !");
           return false;
        }
        if(document.getElementById('gg').value == null ||
        document.getElementById('gg').value == "") {
           alert("NO publish_date !");
           return false;
        }
        if(document.getElementById('cc').value == null ||
...
<body>
    <s:form action="StoreAll" onsubmit="return checkform()">
    <table cellspacing="0">
            <tbody>
                <tr><td>ADD ALL INFO.</td></tr>
        ...
        <tr><s:textfield name="author.name" label="Name" id="nn"/></tr>
        <tr><s:textfield name="author.age" label="Age" id="gg"/></tr>
        <tr><s:textfield name="author.country" label="Country" id="cc"/></tr>
